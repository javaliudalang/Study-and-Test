...
public class ShootGame extends JPanel {
	...
	static {
		try {
			background = ImageIO.read(ShootGame.class.getResource("background_1.png"));
			...
			bullet = ImageIO.read(ShootGame.class.getResource("bullet_7.png"));
			hero0 = ImageIO.read(ShootGame.class.getResource("1.png"));
			hero1 = ImageIO.read(ShootGame.class.getResource("2.png"));
			pause = ImageIO.read(ShootGame.class.getResource("pause.png"));
			gameover = ImageIO.read(ShootGame.class.getResource("jeimian_2.png"));
